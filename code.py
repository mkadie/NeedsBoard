...
if demo_test :
    odb = displayio.OnDiskBitmap('/milk_test.bmp')
...
if demo_test :
    with open("/milk_test.wav", "rb") as wave_file:
...
PCA9555_Address1 = 0x24 # 24

print (dir(PCA9555))
# Initialize the device and get pins
# Change this if you are not using a PCA9555
# Note : these pins are the latched pins from the MSP430 not the pins connected to the buttons
